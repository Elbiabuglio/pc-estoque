...
class EstoqueSchema(SchemaType): 
    seller_id: str | None = Field(None, min_length=1, description="seller_id não pode ser vazio") 
    sku: str | None = Field(None, min_length=1, description="sku não pode ser vazio") 
    quantidade: int | None = Field(None, ge=0, description="quantidade deve ser maior ou igual a zero")
