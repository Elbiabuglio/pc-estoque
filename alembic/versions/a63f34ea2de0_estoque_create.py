...
def upgrade() -> None:
    ...
    op.bulk_insert(
        ...
        [
            ...
            {'seller_id': 'seller_c', 'sku': 'sku_008', 'quantidade': 90, 'created_at': now, 'updated_at': now},
            {'seller_id': 'seller_c', 'sku': 'sku_009', 'quantidade': 110, 'created_at': now, 'updated_at': now},
            {'seller_id': 'seller_c', 'sku': 'sku_010', 'quantidade': 130, 'created_at': now, 'updated_at': now},
            {'seller_id': 'seller_c', 'sku': 'sku_011', 'quantidade': 140, 'created_at': now, 'updated_at': now},
            {'seller_id': 'seller_c', 'sku': 'sku_012', 'quantidade': 160, 'created_at': now, 'updated_at': now},
            {'seller_id': 'seller_c', 'sku': 'sku_013', 'quantidade': 170, 'created_at': now, 'updated_at': now},
            {'seller_id': 'seller_c', 'sku': 'sku_014', 'quantidade': 180, 'created_at': now, 'updated_at': now},
            {'seller_id': 'seller_c', 'sku': 'sku_015', 'quantidade': 190, 'created_at': now, 'updated_at': now},
